...
async function updateBalance(req, res) {
    const user = await _helpers_api_dal__WEBPACK_IMPORTED_MODULE_1__/* .dal */ .E.updateBalance(req.body).then((response)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [151], () => (__webpack_exec__(1118)));
