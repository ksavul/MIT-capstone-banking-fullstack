    ...
    <Card
      ...
      body={
        <div className="">
          ...
          <p className="fw-bold font-weight-bold">
            Balance :{" "}
            <span className="text-success bg-dark width-medium p-2 rounded">
          ...
          <div className="d-flex flex-wrap flex-column-reverse">
            {props?.userData?.history?.map((item) => (
              <div
                className="bg-lightGray rounded width-meduim  my-2 d-flex "
                style={{ width: "16rem" }}
              >
                <div
                  className="border border-2 rounded bg-light border-light date-item text-dark"
                  style={{ width: 180 }}
                >
                  {item?.date}
                </div>
                ...
                <div
                  ...
                  style={{ fontWeight: "bold", width: 80, alignSelf: "center" }}
                >
  ...
  return (
    <div className="justify-content-center align-items-center d-flex flex-wrap justify-content-around w-100">
      {data?.length > 0 ? (
        <>
          {data.map((user, index) => {
            return <UserDataCard userData={user} key={index} />;
          })}
        </>
      ) : loading ? (
